        ...
        <div>
            <div className='Selenium'>
                <div className='seleniumleft'>
                    ...
                    <img src={selenium2} className='selenium1' alt='selenium2'/>
                    ...
                    <img src={selenium3} className='selenium1' alt="selenium"/>
                    ...
                    <img src={selenium4} className='selenium1' alt="selenium"/>
                    ...
                    <img src={selenium5} className='selenium1' alt="selenium"/>
                    ...
                    <img src={selenium6} className='selenium1' alt="selenium"/>
                    ...
                    <img src={selenium7} className='selenium1' alt="selenium"/>
