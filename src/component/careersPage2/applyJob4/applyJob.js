        ...
        <div className='applyJob'>
          <div className='job'>
            <div className='details'>
              <p id='detailsText'>BACKEND LEAD</p>
              <p id='experiancerText'><img src={experianceImg} alt='experiance'></img> 7+ Years Experience</p>
            </div>
          ...
          <div className='descripition'>
            <div className='jobDescripition'>
              ...
              <ul>
                <li> <img src={TickImg} alt='tickImg'></img> 7+ years of experience in creating large-scale data pipeline.</li>
                <li><img src={TickImg} alt='tickImg'></img>Extensive Python, API (Flask) development experience.</li>
                <li><img src={TickImg} alt='tickImg'></img> Proficient in SQL.</li>
                <li><img src={TickImg} alt='tickImg'></img>Experience with Web services, Github, Application Security, Kubernetes, Docker, Helm.</li>
                <li><img src={TickImg} alt='tickImg'></img> Experience with AWS.</li>
                <li><img src={TickImg} alt='tickImg'></img>Experience working for a startup and/or SaaS organization.</li>
              </ul>
            ...
            <div className='skillsRequired'>
              ...
              <ul>
                <li><img src={TickImg} alt='tickImg'></img><p id='SkillPara'>Knowledge on SAP.</p></li>
                <li><img src={TickImg} alt='tickImg'></img><p id='SkillPara'>UNIX/Linux basic command line experience.</p></li>
              </ul>
