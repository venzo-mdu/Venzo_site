    ...
    return (
        <div className='devCaros'>
            ...
            <div className='webSlide1'>
                ...
                <a href='https://tringapps.com/'  target="_blank">
